...
export function Sidebar() {
  ...
  return (
    <aside className="hidden lg:flex fixed top-1/2 left-2/5 -translate-x-full -translate-y-1/2 w-96 py-10 bg-slate-900/80 backdrop-blur-lg z-50 flex-col justify-between h-full">
      {/* Top */}
